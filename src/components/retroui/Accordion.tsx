...
function AccordionExample(
  props: React.PropsWithChildren<{ header: React.ReactNode }>,
) {
  return (
    <AccordionComponent type="single" collapsible className="space-y-4 w-full">
      <AccordionComponent.Item value="example">
        <AccordionComponent.Header>{props.header}</AccordionComponent.Header>
...
export { AccordionExample as Accordion };
